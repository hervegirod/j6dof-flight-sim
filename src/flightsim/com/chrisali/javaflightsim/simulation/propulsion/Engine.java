...
public abstract class Engine {
    ...
    */
   public abstract void updateEngineState(Map<FlightControlType, Double> controls, Map<EnvironmentParameters, Double> environmentParameters, double[] windParameters);
